...
MODEL_PATH = PROJECT_ROOT / "models" / "after_loan_classifier_model"
ONNX_PATH = PROJECT_ROOT / "models" / "onnx"
...
encoded = tokenizer(text_a, text_b, return_tensors="pt", truncation=True,
...
onnx_file = ONNX_PATH / "advisor.onnx"
with torch.no_grad():
    torch.onnx.export(
        model,
