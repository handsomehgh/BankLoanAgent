...
from config.constants import CollectionNames, MemoryType
from config.settings import agentConfig
from scripts.db_scripts.init_milvus_memory_collecitons import BM25_FUNCTION
...
COL_FIELDS = [
    ...
    FieldSchema(name="external_id", dtype=DataType.ARRAY, element_type=DataType.VARCHAR, max_capacity=20,max_length=20),
