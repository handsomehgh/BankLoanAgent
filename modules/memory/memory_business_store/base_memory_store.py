...
from modules.memory.memory_constant.constants import MemoryStatus, ProfileEntityKey
...
class BaseMemoryStore(ABC):
    ...
    @abstractmethod
    def get_sub_recent_interactions(self, user_id: str, limit: int = 5) -> List[Dict[str, Any]]:
        """
        retrieve the user's recent interaction logs,sorted in reverse chronological order
    ...
    @abstractmethod
    def get_all_user_profile_memories(self, user_id: str, status: MemoryStatus = MemoryStatus.ACTIVE) -> List[Dict[str, Any]]:
